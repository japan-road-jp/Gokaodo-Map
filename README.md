...
## 概　 要    
地理情報システム（GIS：Geographic Information System）で表示や再利用ができる五街道のデータは，2020年現在，インターネット上で検索して確認した限りは見当たりません．
本データセットは五街道（東海道，中山道，日光街道，奥州街道，甲州街道）のGPX(GPS eXchange Format)とKML（Keyhole Markup Language） フォーマットについてまとめたもので．GISソフトやアプリへドラッグ・アンド・ドロップもしくはインポートしますとトラックファイル（ポイントデータ）が線として表示することができます．
